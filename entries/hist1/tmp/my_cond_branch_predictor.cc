...
// derived from Author: Toru Koizumi et al
...
bool CBP2025_HIST1::predict(uint64_t seq_no, uint8_t piece, uint64_t PC) { return p_impl->predict(seq_no, piece, PC); }
void CBP2025_HIST1::update(uint64_t seq_no, uint8_t piece, uint64_t PC, bool resolveDir, bool predDir, uint64_t nextPC) { p_impl->update(seq_no, piece, PC, resolveDir, predDir, nextPC); }
void CBP2025_HIST1::history_update(uint64_t seq_no, uint8_t piece, uint64_t PC, int brtype, bool pred_dir, bool resolve_dir, uint64_t nextPC) { p_impl->history_update(seq_no, piece, PC, brtype, pred_dir, resolve_dir, nextPC); }
void CBP2025_HIST1::TrackOtherInst(uint64_t PC, int brtype, bool pred_dir, bool resolve_dir, uint64_t nextPC) { p_impl->TrackOtherInst(PC, brtype, resolve_dir, pred_dir, nextPC); }
void CBP2025_HIST1::terminate() { p_impl->terminate(); }
void CBP2025_HIST1::decode_notify(uint64_t seq_no, uint8_t piece, uint64_t dst_reg) { p_impl->decode_notify(seq_no, piece, dst_reg); }
void CBP2025_HIST1::execute_notify(uint64_t seq_no, uint8_t piece, uint64_t dst_reg, uint64_t value) { p_impl->execute_notify(seq_no, piece, dst_reg, value); }
